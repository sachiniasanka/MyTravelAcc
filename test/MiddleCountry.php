        ...
        <div class="container">
            <div class="row multi-columns-row">
                <div class="col-md-4 col-sm-6 col-xs-12"><a class="content-box" //href="index_mp_fullscreen_video_background.html">
                    <div class="content-box-image"><img src="assets/images/screenshots/rawanaAlla.png" alt="Main Demo"></div>
                    <h3 class="content-box-title font-serif">Rawana Ella </h3></a></div>
                <div class="col-md-4 col-sm-6 col-xs-12"><a class="content-box" //href="index_agency.html">
                    <div class="content-box-image"><img src="assets/images/screenshots/world'sEnd.png" alt="Agency"></div>
                    <h3 class="content-box-title font-serif">World'End </h3></a></div>
                <div class="col-md-4 col-sm-6 col-xs-12"><a class="content-box" //href="index_portfolio.html">
                    <div class="content-box-image"><img src="assets/images/screenshots/adom's%20peak.jpg" alt="Portfolio"></div>
                    <h3 class="content-box-title font-serif">Adom's Peak </h3></a></div>
