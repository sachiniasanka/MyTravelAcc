    ...
    <div class="container">
        <div class="row multi-columns-row">
            <div class="col-md-4 col-sm-6 col-xs-12"><a class="content-box" //href="index_mp_fullscreen_video_background.html">
                <div class="content-box-image"><img src="assets/images/screenshots/keerimalai.jpg" alt="Main Demo"></div>
                <h3 class="content-box-title font-serif">Keerimalai</h3></a></div>
            <div class="col-md-4 col-sm-6 col-xs-12"><a class="content-box" //href="index_agency.html">
                <div class="content-box-image"><img src="assets/images/screenshots/trincoHarbour.jpg" alt="Agency"></div>
                <h3 class="content-box-title font-serif">TrincoHarbour</h3></a></div>
            <div class="col-md-4 col-sm-6 col-xs-12"><a class="content-box" //href="index_portfolio.html">
                <div class="content-box-image"><img src="assets/images/screenshots/hinduTemple.jpg" alt="Portfolio"></div>
                <h3 class="content-box-title font-serif">Nagadipaya</h3></a></div>
...
<!--            </div>-->
            ...
            <button  type="button" id="btnPlaceOrder" class="btn bg-gray-active"><a href="LoginClinet.php">Book</a></button>
        </div>
