    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index.html">myTraveller(Admin)</a>
            </div>
            <div class="collapse navbar-collapse" id="custom-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!--                    </li>-->
                            ...
                            <li><a href="LoginAdmin.php">Registration </a></li>
                    ...
                    <li><a href="ManageClients.php"> Client </a></li>
                    <li><a href="ManageHotel.php"> Hotel </a></li>
                    <li><a href="ManageTransportl.php"> Transport </a></li>
                    <li><a href="ManageGuide.php"> Guide </a></li>
                    <li><a href="ManageTripDays.php"> Day </a></li>
                    <li><a href="ManagePlace.php"> Place </a></li>

                    <li><a href="Booking.php"> Booking</a></li>
                    <!--                                <ul class="dropdown-menu">-->
                    <!--<!--                                    <li><a href="packages.php">view</a></li>-->-->
                    ...
                    <!--                        </ul>-->
                    <!--                    </li>-->
                    <!--                    <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Client</a>-->
                    <!--                        <ul class="dropdown-menu" role="menu">-->
